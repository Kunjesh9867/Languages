...
- this version does not takes any input arguments and does not return any value.
*/

 /*
 public void maximum(arguments list) { ..statements.. } - function definition in java and C#
 */
...
func maximumValue(){
    ...
    print("Maximum Function by kunjesh: \(maximum)")
}
maximumValue()
...
func maximum() {
    ...
    print("Ver 1.0: Maximum of three values 3.6, 4.2, 2.7: \(maximumValue)")
} //end func - maximum
...
//...Example 07: Function with Default parameter values
...
// inout is similar to ref in java and CSharp
...
square(value: &x) // function Call by ref
