...
2. It is group data values/item which are given a common name
...
let integers12 = [Int]() // Clarity: Using () to create an empty instance of a type is clear and concise.
print("integers12: \(integers12.description)")

let integers13: [Int] = []
print("integers13: \(integers13.description)")
...
print("booleans: \(booleans.description)") // booleans: [true, true, true, true, true]
...
print("Type: \(type(of: integers3)) integers3: \(integers3.description)")
...
print(stockvalues[0...2]) // [66.7, 175.0, 80.5]
print(stockvalues[0]) // 66.7
print(stockvalues[1]) // 175.0
print(stockvalues[2]) // 80.5
...
items[0] = 100
// items[5] = 66  KUNJESH = capacity of array is different
...
print("integers6: \(integers6.description)")
 ...
 print("numbers: \(numbers.description)")
 numbers[5...9] = [50, 60, 70] // elements between index values 5 and 9 i.e. 5, 6, 7, 8, 9
