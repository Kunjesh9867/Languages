...
// Calling the function with three string values values
print("Maximum of pear, apple, orange is ")
print(maximum("pear", "apple", "orange")) // this based on ascii values

// TODO:
// You can try now func minimum<T:Comparable>( _ x: T, _ y:T, _ z:T) { ... }
