...
//^ TRULY AND FALSY VALUES
{
    ...
    const money = 0;
    if (money) {
        // here, JS convert money(from 0 to false) . This conversion is based on truly or falsy value
    ...
    //? == (after type coercion [Value])
    //? === (before type coercion [Value + Datatype])

    const age = '18';
    if (age === 18) console.log('Strict');
    if (age == 18) console.log('Loosy');
